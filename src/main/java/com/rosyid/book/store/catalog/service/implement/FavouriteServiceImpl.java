...
//        // not found
//        if (user == null)
//            throw new HttpServerErrorException(HttpStatus.BAD_REQUEST, "User with id: " + userId + " not found");
//        // not matched
...
//            if (product == null)
//                throw new HttpServerErrorException(HttpStatus.BAD_REQUEST, "Product with id: " + userId + " not found");
//
//            // detail
...
//    }
    ...
    public FavouriteResponse saveOrUpdate(FavouriteRequest request) {
        ...
        if (favourite == null) {
            ...
            Product product = productRepository.findById(request.getProductId()).orElse(null);
            if (product == null)
                throw new HttpServerErrorException(HttpStatus.BAD_REQUEST, "Product with id: " + request.getProductId() + " not found");
            ...
            List<FavouriteDetail> currentFavouriteBookDetails = favouriteDetailRepository.findByUserIdAndProductId(user.getId(), product.getId());
...
//    }
    ...
    public FavouriteResponse deleteByFavouriteDetailId(Long detailId) {
        ...
        if (favouriteBookDetail == null)
            throw new HttpServerErrorException(HttpStatus.BAD_REQUEST, "Favourite Product Detail with id: " + detailId + " not found");
